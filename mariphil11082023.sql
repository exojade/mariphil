...
insert  into `forms`(`form_id`,`form_type`,`date_created`,`timestamp`,`time_created`,`created_by`,`form_kind`,`school_year_id`) values 
('FORM-f439bc30d8606-231108','QUARTERLY','2023-11-08','1699436316','17:38:36','USR-3f92b0d251264-230523','FIRST QUARTER','sy0002');
...
CREATE TABLE `monthly_monitoring` (
  ...
  `form_status` enum('DONE','RETURNED','FOR CHECKING') DEFAULT NULL,
  PRIMARY KEY (`tbl_id`),
...
insert  into `monthly_monitoring`(`tbl_id`,`form_id`,`scholar_id`,`grades`,`grade_card_upload`,`achievements`,`remarks`,`form_status`) values 
('QUARTERLY-01cbb5cd963ab-231108','FORM-f439bc30d8606-231108','USR-1b4b5b7439500-231108',NULL,NULL,NULL,NULL,'FOR CHECKING');
...
('QUARTERLY-01cbb5cd963ab-231108','Best in Thesis','ACH-00fcbfec604c6-231108'),
('QUARTERLY-01cbb5cd963ab-231108','Honorable Mention','ACH-6d9ed30e43296-231108');
