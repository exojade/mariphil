            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php
                  $list = query("select * from scholars where current_status = 'SCHOLAR' and responsible is not null and sponsor_id is null");
                  foreach($list as $l):  ?>
                    <tr>
                      <td>
                        <form class="generic_form_trigger" data-url="sponsor" style="display:inline;">
                          <input type="hidden" name="action" value="sponsorScholar">
