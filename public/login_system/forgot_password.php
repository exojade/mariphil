...
<div class="lockscreen-wrapper">
  <div class="lockscreen-logo">
    <a style="color:#fff;" href="AdminLTE_new/index2.html"><b>Forgot Password</b></a>
  </div>
  <div class="lockscreen-item">
    <form class="lockscreen-credentials generic_form_trigger" data-url="login">
  ...
  <div class="help-block text-center" style="color:#fff;">
    Enter your email address! If it exists, it will be sent to your email!
  </div>
</div>
</div>
