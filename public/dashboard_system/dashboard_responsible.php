<div class="content-wrapper">
    ...
    <?php
      ...
      $vacant = query("select count(*) as count from scholars where current_status 
      in ('APPLICANT - INTERVIEWED')");
      $vacant = $vacant[0]["count"];
          ...
          <div class="col-12 col-sm-6 col-md-6">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">My Scholars</span>
          ...
          <div class="col-12 col-sm-6 col-md-6">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo($forms); ?></span>
              </div>
            </div>
          </div>
        </div>
